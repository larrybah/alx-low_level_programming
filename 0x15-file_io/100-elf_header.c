...
/**
 * check_elf - This will checks if a file is an ELF file.
...
/**
 * print_magic - This prints the magic numbs of an ELF header.
 * @e_ident: A pointer to an array containing the ELF magic numbs.
 *
 * Description: Magic numbs are separated by spaces.
 */
void print_magic(unsigned char *e_ident)
{
	int index;
